    ...
    public partial class FirstTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "The quality of the photos is incredible.", "https://http2.mlstatic.com/D_NQ_NP_637616-MLA70484274053_072023-O.webp", 1, 5, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4422) },
                    { 2, "Very good purchase, it arrived very quickly and it arrived like a totally new phone, it only has very slight details on the sides.", "https://m.media-amazon.com/images/I/71a4vqXqxbL._SY256.jpg", 1, 5, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4437) },
                    { 3, "Good!", "https://http2.mlstatic.com/D_NQ_NP_2X_743184-MLA69501979268_052023-F.webp", 1, 4, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4438) },
                    { 4, "The best smartphone I've ever used!!! I left an iPhone 14 Pro Max, sold it, bought the S23 Ultra and still had money left. There's no comparison, with 8gb of ram you can use several applications in the background at the same time.", "https://http2.mlstatic.com/D_NQ_NP_2X_936910-MLA54765476953_032023-F.webp", 2, 5, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4439) },
                    { 5, "Excellent, after all it is an Apple product. Worth every penny given ❤.", "https://http2.mlstatic.com/D_NQ_NP_2X_960098-MLA73264672831_122023-F.webp", 3, 5, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4440) },
                    { 6, "The best.", "https://http2.mlstatic.com/D_NQ_NP_2X_911842-MLA73095448948_112023-F.webp", 4, 4, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4442) },
                    { 7, "New original product you can buy without fear!.", "https://http2.mlstatic.com/D_NQ_NP_2X_696237-MLA71736945652_092023-F.webp", 5, 5, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4443) },
                    { 8, "Excellent product, came sealed.", "https://http2.mlstatic.com/D_NQ_NP_2X_918056-MLA72166744514_102023-F.webp", 5, 5, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4444) },
                    { 9, "Perfect product.", "https://http2.mlstatic.com/D_NQ_NP_2X_661229-MLA72108620029_102023-F.webp", 6, 5, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4445) },
                    { 10, "The best product, very good!", "https://http2.mlstatic.com/D_NQ_NP_2X_942915-MLA54965635426_042023-F.webp", 6, 4, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4446) },
                    { 11, "Pay attention to size. Nike models are smaller. The ideal is to buy 1 size larger.", "", 7, 4, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4448) },
                    { 12, "It was small on me. I want to return it. To get my refund.", "", 7, 1, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4449) },
                    { 14, "Excellent product.", "", 9, 5, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4450) },
                    { 15, "I liked the original, it has to be laced but it's perfect.", "", 10, 5, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4451) },
                    { 16, "I'm a fan of this sneaker. One of the most beautiful on the foot, in my opinion.", "", 10, 4, new DateTime(2024, 2, 8, 23, 13, 51, 291, DateTimeKind.Local).AddTicks(4452) }
                });
