        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductDataObjectValue_ReleaseMonth = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: false),
                    ProductDataObjectValue_ReleaseYear = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: false),
                    ProductImageObjectValue_MainImage = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: false),
                    ProductImageObjectValue_ImageFirst = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: false),
                    ProductImageObjectValue_ImageSecond = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: false),
                    ProductImageObjectValue_ImageThird = table.Column<string>(type: "nvarchar(600)", maxLength: 600, nullable: false),
                    ProductPriceObjectValue_Price = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ProductPriceObjectValue_HistoryPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ProductSpecificationsObjectValue_ProductModel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ProductSpecificationsObjectValue_ProductBrand = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ProductSpecificationsObjectValue_ProductLine = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ProductSpecificationsObjectValue_ProductWeight = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ProductSpecificationsObjectValue_ProductType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ProductWarrantyObjectValue_WarrantyLength = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ProductWarrantyObjectValue_WarrantyInformation = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ...
                    GameSpecificationsObjectsValue_AudioLanguages = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "The quality of the photos is incredible.", "https://http2.mlstatic.com/D_NQ_NP_637616-MLA70484274053_072023-O.webp", 1, 5, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6006) },
                    { 2, "Very good purchase, it arrived very quickly and it arrived like a totally new phone, it only has very slight details on the sides.", "https://m.media-amazon.com/images/I/71a4vqXqxbL._SY256.jpg", 1, 5, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6022) },
                    { 3, "Good!", "https://http2.mlstatic.com/D_NQ_NP_2X_743184-MLA69501979268_052023-F.webp", 1, 4, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6023) },
                    { 4, "The best smartphone I've ever used!!! I left an iPhone 14 Pro Max, sold it, bought the S23 Ultra and still had money left. There's no comparison, with 8gb of ram you can use several applications in the background at the same time.", "https://http2.mlstatic.com/D_NQ_NP_2X_936910-MLA54765476953_032023-F.webp", 2, 5, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6024) },
                    { 5, "Excellent, after all it is an Apple product. Worth every penny given ❤.", "https://http2.mlstatic.com/D_NQ_NP_2X_960098-MLA73264672831_122023-F.webp", 3, 5, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6024) },
                    { 6, "The best.", "https://http2.mlstatic.com/D_NQ_NP_2X_911842-MLA73095448948_112023-F.webp", 4, 4, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6025) },
                    { 7, "New original product you can buy without fear!.", "https://http2.mlstatic.com/D_NQ_NP_2X_696237-MLA71736945652_092023-F.webp", 5, 5, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6026) },
                    { 8, "Excellent product, came sealed.", "https://http2.mlstatic.com/D_NQ_NP_2X_918056-MLA72166744514_102023-F.webp", 5, 5, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6027) },
                    { 9, "Perfect product.", "https://http2.mlstatic.com/D_NQ_NP_2X_661229-MLA72108620029_102023-F.webp", 6, 5, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6027) },
                    { 10, "The best product, very good!", "https://http2.mlstatic.com/D_NQ_NP_2X_942915-MLA54965635426_042023-F.webp", 6, 4, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6028) },
                    { 11, "Pay attention to size. Nike models are smaller. The ideal is to buy 1 size larger.", "", 7, 4, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6029) },
                    { 12, "It was small on me. I want to return it. To get my refund.", "", 7, 1, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6030) },
                    { 14, "Excellent product.", "", 9, 5, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6030) },
                    { 15, "I liked the original, it has to be laced but it's perfect.", "", 10, 5, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6031) },
                    { 16, "I'm a fan of this sneaker. One of the most beautiful on the foot, in my opinion.", "", 10, 4, new DateTime(2024, 1, 8, 22, 42, 32, 113, DateTimeKind.Local).AddTicks(6032) }
                });
