...
{
    public class ProductImageOV
    {
        [Required(ErrorMessage = "Image is required.")]
        [StringLength(500, ErrorMessage = "Maximum {1} characters.")]
        [DisplayName("Main image")]
        public string MainImage { get; protected set; } = string.Empty;

        [StringLength(500, ErrorMessage = "Maximum {1} characters.")]
        public string ImageFirst { get; protected set; } = string.Empty;

        [StringLength(500, ErrorMessage = "Maximum {1} characters.")]
        public string ImageSecond { get; protected set; } = string.Empty;

        [StringLength(500, ErrorMessage = "Maximum {1} characters.")]
        public string ImageThird { get; protected set; } = string.Empty;
