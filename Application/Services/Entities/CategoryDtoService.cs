...
namespace Application.Services.Entities
{
    public class CategoryDtoService(IMapper mapper, ICategoryRepository categoryRepository) : ICategoryDtoService
    {
        ...
        {
            var categoriesDto = await _categoryRepository.GetCategoriesAsync();
        ...
        {
            if (categoryDto == null)
                throw new ArgumentNullException(nameof(categoryDto), "The category cannot be null.");
        ...
        public async Task<List<CategoryWithProductCount>> GetCategoriesWithProductCountAsync()
        {
            ...
            if (categoriesWithProductCount == null || !categoriesWithProductCount.Any())
            {
                return new List<CategoryWithProductCount>();
            }
            return _mapper.Map<List<CategoryWithProductCount>>(categoriesWithProductCount);
        }
