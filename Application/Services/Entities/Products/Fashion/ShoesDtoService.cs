    ...
    public class ShoesDtoService(IMediator mediator, IMapper mapper) : IShoesDtoService
    {
        ...
        public async Task DeleteAsync(int? id)
        {
            ...
            try
            {
                ...
                if (deleteShoes == null)
                    throw new RequestException(new RequestError
                    {
                        Message = "Error when creating RemoveShoesCommand.",
                        Severity = "Error",
                        StatusCode = System.Net.HttpStatusCode.InternalServerError
                    });
            ...
            {
                throw new Exception("Unexpected error occurred while deleting the shoes.", ex);
            }
        }
        ...
        public async Task<ShoesDto> GetByIdAsync(int? id)
        {
            ...
            try
            {
                ...
                return _mapper.Map<ShoesDto>(result);
            }
            catch (RequestException)
            {
                throw;
            ...
            {
                throw new Exception("Unexpected error occurred while fetching the shoes by ID.", ex);
            }
        }
